            ...
            <div style={{width: '100%'}}>
                <table className="price_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="closed-games-row">
                                <span style={{fontWeight: 600}}>8000₽</span>
                ...
                <div className="price-container">
                    ...
                    <div className="price-row">
                        <span style={{fontWeight: 600}}>8000₽</span> <span>2 часа</span>
                    </div>
                    <div className="price-row">
                        <span style={{fontWeight: 600}}>11000₽</span> <span>3 часа</span>
                    </div>
